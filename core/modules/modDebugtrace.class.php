 ...
 */
class modDebugtrace extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        // (where XXX is value of numeric property 'numero' of module)
        $this->description = "Debug debugtrace";
        ...
        $this->module_parts = array(
            ...
            ,'js' => array('/debugtrace/js/trace.js.php')
        );
    ...
    //    $this->config_page_url = array("admin_mymodule.php@mymodule");
        ...
        $this->langfiles = array("debugtrace@debugtrace"); // langfiles@mymodule
        // Constants
        ...
        // Dictionnaries
        if (! isset($conf->debugtrace->enabled)) {
            $conf->debugtrace=new stdClass();
            $conf->debugtrace->enabled = 0;
        }
